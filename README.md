...
Continuo is built to **deliver Instagram follower leads**, not to automate marketing actions.

It:
- Extracts **public Instagram follower leads** based on explicit rules
...
## What Continuo does NOT do

Continuo does **not**:
- Send messages or DMs
- Automate outreach or engagement
- Scrape private or restricted data
- Bypass platform protections
- Guarantee conversions, replies, or sales outcomes

The separation between **data delivery** and **marketing execution** is a core design principle.
...
- How delivered leads are used
- Ensuring downstream outreach complies with applicable regulations (e.g. GDPR, ePrivacy)

---

## Delivery formats

Leads can be delivered as:
- Structured CSV files
- Direct CRM ingestion (depending on configuration)

Each delivery includes:
- Deduplicated entries
- Normalized fields
- Clear volume definitions
...
No subscription is required for basic delivery.
...
This repository contains the **official landing and documentation layer** for Continuo.

It is not a scraping tool, bot, or automation engine.
...
Continuo provides **data delivery only**.
